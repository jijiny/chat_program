...
<script type="text/javascript">
	...
	function getFriend(findID){
		$('#friendResult').html('<thead>'+
				...
				'<tbody>'+
				'<tr>'+
				'<td style="text-align:center;"><h3>'+findID+'</h3><a href="chat.jsp?toID='+encodeURIComponent(findID)+'"style="background-color:#423630" class="btn btn-primary pull-right">'+
				'메시지 보내기</a></td>'+
				'</tr>'+
				'</tbody>');
	}
...
<body>
	<nav class="navbar navbar-default">
      <div class="navbar-header">
         ...
         <a class="navbar-brand" href="index.jsp">KAKAO TALK</a>
      </div>
	...
	<div class="container">
		<table class="table table-bordered table-hover" style="text-align:center; border:1px solid #dddddd">
			...
			<tbody>
				...
				<tr>
					<td colspan="2"><button style="background-color: #423630; border-color:#423630" class="btn btn-primary pull-right" onclick="findFunction();">검색</button></td>
				</tr>
			</tbody>
		</table>
	</div>
